        ...
        <div className="relative max-w-screen-xl mx-auto px-8 py-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <Link href="/institution/egresados"
                className="flex items-center gap-2 bg-[#6bfe9c] text-[#00210c] px-5 py-3 rounded-2xl font-bold text-sm hover:opacity-90 transition shadow-lg">
      ...
      <div className="max-w-screen-xl mx-auto px-8 py-8 space-y-8">
              ...
              return (
                <div key={key}>
                  ...
                  <div className="h-2 bg-[#f2f4f6] rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-[#00386c] to-[#006d37] rounded-full transition-all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl border border-[#e6e8ea] p-6">
            ...
            <SkillBars items={data?.marketDemandSkills ?? []} countKey="count" accent="text-[#006d37]" barClass="bg-[#006d37]" />
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#e6e8ea] p-6">
            ...
            <SkillBars items={data?.graduateSkills ?? []} countKey="count" accent="text-[#00386c]" barClass="bg-[#00386c]" />
          </div>
        </div>
        ...
        <Link href="/institution/empleabilidad"
          ...
          <ChevronRight className="w-5 h-5 text-[#737781] group-hover:text-[#00386c]" />
        </Link>
      </div>
    </div>
  );
